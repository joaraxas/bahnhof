...
public:
    ...
    void rendertexture(SDL_Texture* tex, SDL_Rect* rect, SDL_Rect* srcrect=nullptr, Angle angle=Angle(0), bool ported=true, bool zoomed=true, bool originiscenter=false, int centerx=0, int centery=0);
